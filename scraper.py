...
class Scraper:
    ...
    def search(self):
        ...
        neweggindia_start_time = time.time()
        neweggindia_products_data = self.search_neweggindia()
        neweggindia_end_time = time.time()

        primeabgb_start_time = time.time()
        primeabgb_products_data = self.search_primeabgb()
        primeabgb_end_time = time.time()
        ...
        # print(neweggindia_products_data)
        # print(primeabgb_products_data)
        ...
        # print("Time to scrape Newegg India =", neweggindia_end_time - neweggindia_start_time)
        # print("Time to scrape Prime ABGB =", primeabgb_end_time - primeabgb_start_time)
